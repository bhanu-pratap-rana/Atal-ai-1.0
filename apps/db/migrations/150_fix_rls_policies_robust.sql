-- Migration 150: Robust fix for RLS policies on units and sync_log tables
...
-- ============================================================================
-- VERIFICATION (run this query after migration to confirm)
-- ============================================================================
-- SELECT policyname, cmd, qual::text, with_check::text
-- FROM pg_policies WHERE tablename IN ('units', 'sync_log');
-- Expected:
--   units_select, units_service_insert, units_service_update, units_service_delete
--   sync_log_student_read, sync_log_student_insert
