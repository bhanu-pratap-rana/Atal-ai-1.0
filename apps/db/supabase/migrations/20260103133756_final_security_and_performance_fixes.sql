...
-- ai_tutor_interactions: Add explicit auth check
...
-- irt_item_bank: Add explicit auth check
...
-- learning_style_profile: Add explicit auth check
...
-- student_badges: Add explicit auth check
...
-- student_knowledge_state: Add explicit auth check
