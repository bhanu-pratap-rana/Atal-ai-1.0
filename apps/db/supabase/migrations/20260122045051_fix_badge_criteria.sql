...
-- Also fixes: student_progress table doesn't exist - use student_knowledge_state instead
--
-- =====================================================
...
BEGIN
  ...
  LOOP
    ...
    CASE v_badge.unlock_criteria->>'type'
      -- Existing criteria (FIXED: use student_knowledge_state, not student_progress)
