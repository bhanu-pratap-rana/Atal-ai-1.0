-- =====================================================
-- Migration: Consolidate Remaining Permissive Policies
-- =====================================================
--
-- Fixes remaining multiple_permissive_policies warnings for:
-- 1. class_announcements - teachers_manage + students_read (FOR ALL includes SELECT)
-- 2. class_materials - teachers_manage + students_read (FOR ALL includes SELECT)
